<div style="border-left:4px solid red; padding:0.5em; background-color:#ffe5e5;">
  <strong>⚠️ Deprecated:</strong> This Hyprland configuration is no longer actively maintained.
  Many changes have occurred in Hyprland and related tools since this setup.
  Use this only <strong>as a reference</strong>. It will <strong>not work</strong> on the latest versions.
</div>
